...
docker tag `docker images -q --filter reference=config:1.0.0` registry.cn-beijing.aliyuncs.com/winteree/config:1.0.0 && \
docker push registry.cn-beijing.aliyuncs.com/winteree/config:1.0.0 && \
