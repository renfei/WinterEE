...
docker tag `docker images -q --filter reference=eureka:1.0.0` registry.cn-beijing.aliyuncs.com/winteree/eureka:1.0.0 && \
docker push registry.cn-beijing.aliyuncs.com/winteree/eureka:1.0.0 && \
