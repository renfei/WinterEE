...
@DisplayName("Test GatewayServiceTests")
...
public class GatewayServiceTests {
    ...
    private static OAuth2Request oAuth2Request;

    @Autowired
    public GatewayServiceTests(LogService logService) {
    ...
    static void init() {
        ...
        response = new HttpServletResponse() {
            ...
            public Collection<String> getHeaderNames() {
                return new ArrayList<String>(){{add("TestHeader");}};
            }
        ...
        oAuth2Request = new OAuth2Request(null, "Test", null, true, null, null, "", null, null);
    }
